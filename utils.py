...
def list2spectbl(datalist, star, sourcefiles):
    """
    Assemble the vector data into the standard MUSCLES spectbl format.
    ...
    dtypes = ['f8']*5 + [datalist[5].dtype] + ['i1']
    descriptions = ['left (short,blue) edge of the wavelength bin',
                    ...
                    'the instrument.']
    cols = [Column(d,n,dt,description=dn,unit=u) for d,n,dt,dn,u in
            zip(datalist,names,dtypes,descriptions,units)]
